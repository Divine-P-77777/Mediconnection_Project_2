...
const DoctorHomePage: FC = () => {
  ...
  const username: string =
    data?.name || user?.email?.split("@")[0] || "Doctor";

  return (
    <div
      className={`transition-colors pt-20 min-h-screen ${isDarkMode
        ...
        <>
          <section className="min-h-screen px-6 flex flex-col items-center justify-center">
            <div className="text-center space-y-4 max-w-2xl">
              <h2 className="text-3xl font-semibold pt-20 tracking-wide text-cyan-500 dark:text-cyan-400">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-400 max-w-xl mx-auto">
                Manage patients, appointments, services, availability, and your
                profile — all from one professional dashboard.
              </p>
            </div>
            ...
            <div className="grid gap-6 mt-14 sm:grid-cols-2 md:grid-cols-3 w-full max-w-4xl">
              {[
                ...
                <Link
                  key={item.href}
                  href={item.href}
                  className={`px-6 py-5 rounded-2xl shadow-md transition text-center font-semibold ${isDarkMode
            ...
            <AccountNoSet
              ...
              onSuccess={(accountNo: string) =>
                setData((prev) =>
                  prev ? { ...prev, account_number: accountNo } : prev
                )
              }
            />
          </section>
          ...
          <section className="min-h-screen flex flex-col items-center justify-center px-6 py-20">
            ...
            <div className="grid gap-8 sm:grid-cols-2 md:grid-cols-3 w-full max-w-6xl">
              {[
                ...
                <div
                  key={item.title}
                  className={`rounded-2xl p-6 shadow-lg border transition hover:shadow-xl flex flex-col items-center text-center ${isDarkMode
