...
export default function Contact() {
  ...
  return (
    <div
      className={`mt-10 min-h-screen px-6 py-12 md:px-16 ${isDarkMode
    ...
    >
      ...
      <motion.section
        ...
        className={`max-w-2xl mx-auto border p-6 rounded-lg shadow-lg ${isDarkMode
      ...
      >
        ...
        <p className="text-center text-lg mt-2">
          Find the nearest MediConnect center:
        </p>
